  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className="bg-muted-foreground/20 relative grow overflow-hidden rounded-full data-[orientation=horizontal]:h-1 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1"
      >
        <SliderPrimitive.Range
          data-slot="slider-range"
          className="bg-primary absolute select-none data-[orientation=horizontal]:h-1 data-[orientation=vertical]:w-full"
        />
      </SliderPrimitive.Track>
